...
public class TouriststoreGUI extends JFrame {
	  ...
	  public static final String TOURSTORE = "touriststore";
	   ...
	   class ButtonListener implements ActionListener {
	      public void actionPerformed(ActionEvent ae) {
			...
			if (ae.getActionCommand().equals(SUBMIT)) {
			   ...
			   String hotelCus = "\n \nCustomer reserved a touriststore list: ";
			   String cusInfo = hotelCus+"\n Name: " + nm + ",\n ID: " + id + ",\n Nationality: " + na;

			   addCustomer(cusInfo);
			   bMediator.addAllCandidateCus(TOURSTORE,cusInfo);
	           bMediator.updateALlGuis(TOURSTORE, cusInfo);
	        }
	      }
	  }
